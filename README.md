...
Very basic autogenerated [docs](https://docs.rs/keyring). (Only linux docs are available at this time, cross-platform autogenerated docs are not a thing yet). For autogenerated docs on osx or windows, run `cargo doc -p keyring --open`
